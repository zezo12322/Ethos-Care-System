      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-outline-variant/30 p-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold mt-1" dir="ltr">{family.lastVisit ? new Date(family.lastVisit).toLocaleDateString('ar-EG') : 'غير متوفر'}</p>
          </div>
        </div>
      </div>
           ...
           <div className="bg-white rounded-3xl border border-outline-variant/30 overflow-hidden shadow-sm">
             ...
             <div className="p-5 space-y-4">
               {family.cases && family.cases.length > 0 ? (
                 ...
                 <div className="p-6 text-center text-sm text-on-surface-variant bg-surface-container-lowest rounded-2xl border border-dashed border-outline-variant/50">
                    لا توجد حالات أو مساعدات مسجلة لهذه الأسرة حتى الآن.
                 </div>
               )}
             </div>
          </div>
