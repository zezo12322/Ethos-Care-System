...
export default function ServicesPage() {
  ...
  const mainPrograms = [
    {
      title: "التمكين الاقتصادي (خدمةات صغيرة)",
      description: "نستبدل المساعدة المؤقتة بمصدر دخل دائم للأسرة من خلال تمويل خدمات تجارية وزراعية صغيرة (أكشاك، ماكينات خياطة، تربية طيور).",
      icon: "storefront",
      ...
      <main className="flex-1">
        ...
        <section className="bg-primary text-white py-16 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-headline mb-6">الخدمات والخدمات التنموية</h1>
        ...
        <section className="py-20 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12 border-b border-outline-variant/20 pb-6">
              <div>
                <h2 className="text-3xl font-bold font-headline text-on-surface mb-2">الحملات والخدمات الجارية</h2>
